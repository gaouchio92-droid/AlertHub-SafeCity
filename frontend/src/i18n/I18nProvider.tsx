...
const translations = {
  en: {
    ...
    reports: {
      ...
      unresolvedSubtitle:
        'Priority view of active problems that still require operational follow-up.',
      noUnresolved: 'No unresolved problems detected for this period.',
      age: 'Age',
      action: 'Action',
  ...
  fr: {
    ...
    reports: {
      ...
      unresolvedSubtitle:
        'Vue prioritaire des problemes actifs qui demandent encore un suivi operationnel.',
      noUnresolved: 'Aucun probleme non resolu detecte sur cette periode.',
      age: 'Age',
      action: 'Action',
      operationalData: 'Donnees operationnelles',
      viewProblem: 'Voir le probleme',
